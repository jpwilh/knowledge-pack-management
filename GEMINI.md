...
## Dateistruktur
- `offline_knowledge_pack_v3_de.sh`: Das Haupt-Download-Skript (korrigierte 2026 URLs).
...
- **Wartung**: URLs müssen bei 404-Fehlern manuell in `offline_knowledge_pack_v3_de.sh` aktualisiert werden.

## Benutzung
1. **Status prüfen**: `bash status.sh`
2. **Download starten**: `bash offline_knowledge_pack_v3_de.sh`
